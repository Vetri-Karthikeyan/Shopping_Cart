...
namespace Shopping_Cart_API.Controllers
{
    ...
    public class ShoppingController : ControllerBase
    {
        ...
        {
            var result = dataAccess.GetAllUserData();
            return Ok(result);
        }

        [HttpGet("GetAllProductsData")]
        public IActionResult GetAllProductsData()
        {
            var result = dataAccess.GetAllProductsData();
            return Ok(result);
        }
        ...
        {
            var result = dataAccess.BlockUser(userid);
            return Ok(result ? "blocked" : "not blocked");
        }

        [HttpPost("UnblockUser/{userid}")]
        public IActionResult UnBlockUser(int userid)
        {
            var result = dataAccess.UnBlockUser(userid);
            return Ok(result ? "Active" : "not Active");
        }
